    ...
    <section id="about">
      <div class="container">
        ...
        <header class="section-header">
          <h3>VATSIM Adria team</h3>
          <p>Here you can see our team members</p>
        </header>
        <div align="center">
        <table class="table">
	<tbody>
		...
		<tr>
          <td> 1096476</td>
			<td>Filip Markoski</td>
			<td>vACC Director & Operations Manager	 </td>
		</tr>
		<tr>
			<td>81107</td>
			<td>Damir Nožica</td>
			<td>Deputy vACC Director</td>
		</tr>
		<tr>
			<td>1359931</td>
			<td>Marko Tomičić</td>
			<td>Training Department Director	 </td>
		</tr>
		<tr>
			<td>890112</td>
			<td>Mirza Ibrahimović</td>
			<td>PR & Events Manager & TD Deputy Director	 
 </td>
		</tr>
	</tbody>
</table>
